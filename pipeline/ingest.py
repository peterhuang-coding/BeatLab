...
from common import (  # noqa: E402
    CATEGORIES, get_db, mark_job, now_iso, upsert_asset, upsert_job, upsert_rights,
)
...
def ingest_entry(conn, entry: dict, source: str, force: bool) -> tuple[str, str]:
    ...
    try:
        ...
        upsert_rights(transaction_conn,asset_id,state=rights['state'],basis=rights['basis'],snapshot=snapshot)
